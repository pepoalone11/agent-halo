...
| Movement Break | Opt-in Completion Pet opens a camera-free Squat/Overhead Reach chooser; one specific exercise click starts the shared local camera and bundled pose tracker, exercise-specific white/green progress stays local, and the validated main Pomodoro owner starts the prepared break at completion. | Current |
